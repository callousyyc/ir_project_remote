...
// Integer version
#define _IRREMOTEESP8266_VERSION                                               \
  _IRREMOTEESP8266_VERSION_VAL(_IRREMOTEESP8266_VERSION_MAJOR,                 \
                               _IRREMOTEESP8266_VERSION_MINOR,                 \
                               _IRREMOTEESP8266_VERSION_PATCH)
// String version
#define _IRREMOTEESP8266_VERSION_STR                                           \
  MKSTR(_IRREMOTEESP8266_VERSION_MAJOR)                                        \
  "." MKSTR(_IRREMOTEESP8266_VERSION_MINOR) "." MKSTR(                         \
      _IRREMOTEESP8266_VERSION_PATCH)
...
#define _IR_ENABLE_DEFAULT_                                                    \
  false // true  // Unless set externally, the default is on.
...
#ifndef SEND_RAW
#define SEND_RAW true //_IR_ENABLE_DEFAULT_
#endif                // SEND_RAW
...
#define SEND_PANASONIC true //_IR_ENABLE_DEFAULT_
...
#endif // DECODE_MIDEA
#ifndef SEND_MIDEA
#define SEND_MIDEA true //_IR_ENABLE_DEFAULT_
#endif                  // SEND_MIDEA
...
#define SEND_HAIER_AC true //_IR_ENABLE_DEFAULT_
#endif                     // SEND_HAIER_AC
...
#define SEND_PANASONIC_AC true //_IR_ENABLE_DEFAULT_
...
#define SEND_BLUESTARHEAVY _IR_ENABLE_DEFAULT_
     ...
     DECODE_CARRIER_AC84 || DECODE_YORK || DECODE_BLUESTARHEAVY || false)
...
const uint16_t kSanyoLC7461Bits =
    (kSanyoLC7461AddressBits + kSanyoLC7461CommandBits) * 2;
