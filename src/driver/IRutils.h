...
String addSwingHToString(const uint8_t position, const uint8_t automatic,
                         ...
                         const uint8_t middle, const uint8_t right,
                         const uint8_t maxright, const uint8_t off,
...
String addSwingVToString(const uint8_t position, const uint8_t automatic,
                         ...
                         const uint8_t uppermiddle, const uint8_t middle,
                         const uint8_t lowermiddle, const uint8_t low,
                         const uint8_t lowest, const uint8_t off,
                         const uint8_t swing, const uint8_t breeze,
...
String irCommandTypeToString(uint8_t commandType, uint8_t acControlCmd,
                             ...
                             uint8_t timerCmd = 0xFF, uint8_t configCmd = 0xFF);
...
#define GETBITS8(data, offset, size)                                           \
  (((data) &                                                                   \
    ((static_cast<uint8_t>(UINT8_MAX) >> (8 - (size))) << (offset))) >>        \
   (offset))
#define GETBITS16(data, offset, size)                                          \
  (((data) &                                                                   \
    ((static_cast<uint16_t>(UINT16_MAX) >> (16 - (size))) << (offset))) >>     \
   (offset))
#define GETBITS32(data, offset, size)                                          \
  (((data) &                                                                   \
    ((static_cast<uint32_t>(UINT32_MAX) >> (32 - (size))) << (offset))) >>     \
   (offset))
#define GETBITS64(data, offset, size)                                          \
  (((data) &                                                                   \
    ((static_cast<uint64_t>(UINT64_MAX) >> (64 - (size))) << (offset))) >>     \
   (offset))
...
uint8_t setBit(const uint8_t data, const uint8_t position,
               const bool on = true);
void setBit(uint8_t *const data, const uint8_t position, const bool on = true);
void setBit(uint32_t *const data, const uint8_t position, const bool on = true);
void setBit(uint64_t *const data, const uint8_t position, const bool on = true);
